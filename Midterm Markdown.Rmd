...
This predictive model of implores structural and location characteristics to determine home prices in King County, Washington.
...
```{r data_wrangling, cache = TRUE, warning = FALSE}
...
## Sale Price (Dependent Variable) - PROBLEM: ADJUST LEGEND FOR CLARITY
...
## Parks (Independent Variable #1) - FINISH UP HERE AND FIX
...
The matrix below highlights the correlation between variables in the data set for the model and indicates which variables might cause multicollinearity.
...
```{r correlation_plots, cache = TRUE}
...
-   Log transformation was key for the price variable

## Areas for Improvement

-   Consider cutting out home prices over one million or splitting them up (predicted v. observed plot indicates the range got larger with more expensive homes)

# Appendix

Put this shitty model in the appendix -
...
These results highlight a high RMSE (230,053) and MAE (146,935.6) which might mean I should consider cutting off homes about one million...
